...
import { Send, MessageSquare, ArrowLeft, Headphones, Clock, CheckCheck } from "lucide-react";
...
const UserMessages = ({ user, onBack }: UserMessagesProps) => {
  ...
  const getUnreadCount = (complaintId: number) => {
    ...
    const complaintMessages = allMessages.filter((msg: Message) => 
      msg.complaintId === complaintId && msg.sender === 'admin' && !msg.read
    );
  ...
  const markMessagesAsRead = (complaintId: number) => {
    ...
    const updatedMessages = allMessages.map((msg: Message) => 
      msg.complaintId === complaintId && msg.sender === 'admin' 
        ? { ...msg, read: true }
        : msg
    );
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-gray-600">Case #{selectedComplaint.id} - {selectedComplaint.category}</p>
              </div>
            </div>
            ...
            <Card className="mb-6">
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>
                      Submitted on {new Date(selectedComplaint.createdAt).toLocaleDateString()} • {selectedComplaint.buildingCode}
                    </CardDescription>
                  </div>
              ...
              <CardContent>
                <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-complaints-500">
                  <h4 className="font-semibold mb-2">Your Original Issue:</h4>
                ...
                <div className="space-y-4 max-h-96 overflow-y-auto mb-4 bg-gray-50 p-4 rounded-lg">
                  {messages.length === 0 ? (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500">No messages yet. Start the conversation with our support team!</p>
                    </div>
                  ) : (
                          ...
                          >
                            <div className="flex items-center gap-2 mb-1">
                              <p className="text-sm font-medium">
                                {message.sender === 'user' ? 'You' : 'Customer Support'}
                              </p>
                              {message.sender === 'user' && (
                ...
                <div className="border-t pt-4">
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="bg-complaints-600 hover:bg-complaints-700 self-end"
                    >
                      {isSending ? (
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Our support team typically responds within minutes • Auto-refreshing
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Get help with your complaints and issues</p>
            </div>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Click on any case to chat with our customer support team
              </CardDescription>
            </CardHeader>
            <CardContent>
              {complaints.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-400 text-sm">Submit a complaint first to start getting support</p>
                </div>
              ) : (
                        ...
                        <div className="flex justify-between items-start mb-2">
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <h3 className="font-semibold">Case #{complaint.id} - {complaint.category}</h3>
                              {unreadCount > 0 && (
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          {unreadCount > 0 && (
                            <p className="text-xs text-blue-600 font-medium">
                              Support team replied • Click to view
                            </p>
                          )}
                        </div>
                      </div>
